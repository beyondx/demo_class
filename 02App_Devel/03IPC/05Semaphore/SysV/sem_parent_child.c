...
int main()
{
	...
	printf("parent --- pid = %d, childid = %d\n", getpid(), pid);

	printf("parent will realase resouce after 5 seconds\n");
	sleep(5);
	up_sem_v(semid, 0);

	wait(NULL);

	printf("parent clean done\n");

#if 0

	printf("up_sem_init done\n");
